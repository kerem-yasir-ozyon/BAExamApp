...
{
    private const string AdminEmail = "admin@examapp.com";
    private const string AdminPassword = "newPassword";
    //private const string DefaultCity = "İstanbul";

    private const string CandidateAdminEmail = "candidateadmin@examapp.com";
    private const string CandidateAdminPassword = "newPassword";
    private const string BranchName = "Ankara";
